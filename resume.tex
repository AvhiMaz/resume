...
\section{Projects}
  \resumeSubHeadingListStart
    ...
    \resumeProjectHeading
      ...
      \resumeItemListStart
        \resumeItem{Built an AI-powered tweet generation tool that helps users craft viral posts optimized for engagement}
        \resumeItem{Integrated Gemini’s language model via API to generate context-aware, high-impact tweet drafts}
        \resumeItem{Designed a minimal, responsive frontend in TypeScript and deployed the app seamlessly on Vercel}
        \resumeItem{Implemented user session handling and real-time prompt tuning for personalized tweet suggestions}
      \resumeItemListEnd
